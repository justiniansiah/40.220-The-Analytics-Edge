...
######## 0. Set the working environemnt and Load the data
...
# Compute the average value across the clusters for the Action variable. Higher value indicates many movies in the cluster are action movies.
#tapply(data,index,function)
#1st column of dataframe Data is for "Action".
