...
#       FALSE TRUE
# FALSE    92   43
# TRUE    523 1252 #tobit has more false postives (identifies less people in affairs)
#
table(predict2 <= 0, test$time_in_affairs==0)
#       FALSE  TRUE
# FALSE   582 1175 #normal LR falsely identifies alot more ppl as having affairs (false negatives)
# TRUE    33   120
#
